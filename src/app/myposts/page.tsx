  ...
  if (!session) {
    return (
      <div className="flex items-center justify-center">
        <h1 className="text-2xl font-bold">Please sign in to view your posts</h1>
      </div>
    );
  }
  void api.post.all.prefetchInfinite({ q: q ?? undefined, limit: LIMIT, myPosts: true, bookmarks: false });
  return (
    <div>
      <HydrateClient>
        <Suspense
