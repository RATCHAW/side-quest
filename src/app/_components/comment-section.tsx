...
export function CommentSection({ comments, postId, commentsCount }: CommentSectionProps) {
        ...
        {comments.map((comment) => (
          <div key={comment.id} className="flex gap-4">
            ...
            <div className="flex-1">
              ...
              <Button onClick={() => setShowReply(comment.id)} variant="ghost" size="sm" className="mt-2 text-gray-500">
                Reply
              </Button>
